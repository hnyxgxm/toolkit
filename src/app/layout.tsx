    ...
    <html lang="zh-CN" className="dark">
      <body className={`${inter.variable} ${mono.variable} font-sans`}>
        <nav className="fixed top-0 left-0 right-0 z-50 border-b border-white/[0.06] bg-[#0a0a0b]/80 backdrop-blur-xl">
          <div className="w-full px-4 sm:px-6 lg:px-10 2xl:px-48 h-14 flex items-center justify-between gap-3">
        ...
        <main className="relative z-10 w-full px-4 sm:px-6 lg:px-10 2xl:px-48 pt-24 pb-20">
          {children}
        </main>
        <footer className="relative z-10 border-t border-white/[0.06]">
          <div className="w-full px-4 sm:px-6 lg:px-10 2xl:px-48 py-8 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-neutral-600 font-mono">
